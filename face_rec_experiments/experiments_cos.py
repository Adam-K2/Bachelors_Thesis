...
# This skript is doing experiments with cos metric
# MagFace is missing because Face-Ai-Kit is not supporting cos metric
...
if __name__ == '__main__':
    ...
    for i in range(1, 201):
        ...
        for model in ["Facenet", "DeepFace","ArcFace"]:
    ...
    with open('results.csv', 'w', newline='') as csvfile:
        fieldnames = ['img1', 'img2', 'deepfake', 'Facenet_genuine', 'Facenet_fake', 'DeepFace_genuine', 'DeepFace_fake', 'ArcFace_genuine', 'ArcFace_fake']
